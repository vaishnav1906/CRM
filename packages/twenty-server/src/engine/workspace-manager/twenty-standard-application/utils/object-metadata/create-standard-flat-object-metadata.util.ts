  ...
  company: ({
    ...
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        labelSingular: i18nLabel(msg`Clinic`),
        labelPlural: i18nLabel(msg`Clinics`),
        description: i18nLabel(msg`A healthcare clinic or hospital`),
  ...
  opportunity: ({
    ...
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        labelSingular: i18nLabel(msg`Deal`),
        labelPlural: i18nLabel(msg`Deals`),
        description: i18nLabel(msg`A sales deal`),
  ...
  person: ({
    ...
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        nameSingular: 'person',
        namePlural: 'people',
        labelSingular: i18nLabel(msg`Team Member`),
        labelPlural: i18nLabel(msg`Team`),
        description: i18nLabel(msg`An IDDA Assurance team member`),
        icon: 'IconUser',
        isSearchable: true,
        shortcut: 'P',
        duplicateCriteria: [
  ...
  task: ({
    ...
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        nameSingular: 'task',
        namePlural: 'tasks',
        labelSingular: i18nLabel(msg`Follow Up`),
        labelPlural: i18nLabel(msg`Follow Ups`),
        description: i18nLabel(msg`A follow-up activity`),
        icon: 'IconCheckbox',
        isSearchable: true,
        shortcut: 'T',
        labelIdentifierFieldMetadataName: 'title',
