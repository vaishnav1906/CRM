...
>): Record<AllStandardObjectFieldName<'person'>, FlatFieldMetadata> => ({
  ...
  role: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: 'Team member role at IDDA Assurance',
      icon: 'IconBriefcase',
      isNullable: true,
    },
    standardObjectMetadataRelatedEntityIds,
  ...
  department: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: 'Department within IDDA Assurance',
      icon: 'IconBuilding',
      isNullable: true,
      options: [
        {
          id: 'idda0002-0001-4001-8001-000000000001',
          value: 'BUSINESS_DEVELOPMENT',
          label: i18nLabel(msg`Business Development`),
          position: 0,
          color: 'blue',
        },
        {
          id: 'idda0002-0001-4001-8001-000000000002',
          value: 'MARKETING_COMMUNICATION',
          label: i18nLabel(msg`Marketing Communication`),
          position: 1,
          color: 'purple',
        },
        {
          id: 'idda0002-0001-4001-8001-000000000003',
          value: 'SALES',
          label: i18nLabel(msg`Sales`),
          position: 2,
          color: 'green',
        },
        {
          id: 'idda0002-0001-4001-8001-000000000004',
          value: 'ENGINEERING',
          label: i18nLabel(msg`Engineering`),
          position: 3,
          color: 'sky',
        },
        {
          id: 'idda0002-0001-4001-8001-000000000005',
          value: 'RESEARCH',
  ...
  employeeId: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'employeeId',
      type: FieldMetadataType.TEXT,
      label: i18nLabel(msg`Employee ID`),
  ...
  status: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      options: [
        {
          id: 'idda0003-0001-4001-8001-000000000001',
          value: 'ACTIVE',
        ...
        {
          id: 'idda0003-0001-4001-8001-000000000002',
          value: 'ON_LEAVE',
          label: i18nLabel(msg`On Leave`),
          position: 1,
          color: 'yellow',
        },
        {
          id: 'idda0003-0001-4001-8001-000000000003',
          value: 'INACTIVE',
  ...
  reportsTo: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'reportsTo',
      type: FieldMetadataType.TEXT,
      label: i18nLabel(msg`Reports To`),
