...
>): Record<AllStandardObjectFieldName<'opportunity'>, FlatFieldMetadata> => ({
  ...
  stage: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Deal stage in the IDDA lead pipeline`),
      ...
      options: [
        ...
        },
        {
          ...
          label: i18nLabel(msg`Research Completed`),
          position: 1,
          color: 'yellow',
        },
        {
        ...
        },
        {
          ...
          label: i18nLabel(msg`Follow-Up Pending`),
          position: 3,
          color: 'blue',
        },
        {
