...
export const DeleteRecordsCommand = () => {
  ...
  const numberOfSelected = selectedRecords.length;
  const isSingleRecord = numberOfSelected === 1;
  ...
  const title = t`Delete records?`;
  const subtitle = isSingleRecord
    ? t`Are you sure you want to delete this ${objectMetadataItem.labelSingular}? This action cannot be undone.`
    : t`Are you sure you want to delete ${numberOfSelected} ${objectMetadataItem.labelPlural}? This action cannot be undone.`;
  const confirmButtonText = t`Delete ${objectLabel}`;
