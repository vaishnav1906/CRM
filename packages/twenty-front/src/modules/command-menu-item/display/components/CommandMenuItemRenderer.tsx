...
const DANGER_ENGINE_COMPONENT_KEYS = new Set<EngineComponentKey>([
...
const CommandMenuItemButtonRenderer = ({
  ...
  const isDanger =
    ...
    DANGER_ENGINE_COMPONENT_KEYS.has(item.engineComponentKey);

  const command = { key: item.id, label, shortLabel, Icon, isDanger };
